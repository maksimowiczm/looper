...
// global minimum at f(0, 0) = 0 | bounds [-5, 5]
...
// global minimum at f(3, 2), f(−2.8051,3.1313), f(−3.7793,−3.2832), f(3.5844,−1.8481) = 0 | bounds [-5, 5]
pub fn himmelblau(x: &[f64]) -> f64 {
    (x[0].powi(2) + x[1] - 11.).powi(2) + (x[0] + x[1].powi(2) - 7.).powi(2)
}
